...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					<label for="" class="control-label">Nama Project/Pekerjaan</label>
        ...
        <div class="row">
           ...
           <div class="col-md-6">
            <div class="form-group">
              <label for="" class="control-label">PIC Grup/Team Leader</label>
      ...
      <?php endif; ?>
          <div class="col-md-6">
            <div class="form-group">
              <label for="" class="control-label">Operator/Team Members</label>
		...
		<div class="row">
			<div class="col-md-10">
				<div class="form-group">
					<label for="" class="control-label">Deskripsi Pekerjaan</label>
