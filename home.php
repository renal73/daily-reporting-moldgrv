...
<h4 class="text-center mb-5">Indeks Progres Akselerasi Pekerjaan Rata-Rata Per-Hari Per-Grup</h4>
<div class="col">
  <canvas id="myChart" ; style="height: 50vh; width:70vw; margin:0 auto"></canvas>
</div>
...
<script>
  ...
  const data = {
    ...
    datasets: [{
      ...
      {
        label: 'Grup B',
        data: [74, 68, 79, 78, 69], // Menggunakan data sebagai kunci, bukan data1
        fill: false,
        borderColor: 'rgb(192, 75, 75)', // Warna garis bisa diubah
        tension: 0.1,
      },
      {
        label: 'Grup C',
        data: [78, 76, 80, 81, 65], // Menggunakan data sebagai kunci, bukan data2
        fill: false,
        borderColor: 'rgb(75, 75, 192)', // Warna garis bisa diubah
        tension: 0.1,
      },
    ],
  };
